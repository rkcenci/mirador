  ...
  if (window.matchMedia("(min-width:728px)").matches) {
    ...
    $("#carousel_sec_espiritual .carousel-control-next").on("click", function () {
      if (enabledControl === 'right') {
        $("#carousel_sec_espiritual .carousel-inner .carousel-item").animate({ left: -3 * cardWidth + 'px' }, 1000 );
        enabledControl = 'left';
      }
    });
    ...
    $("#carousel_sec_espiritual .carousel-control-prev").on("click", function () {
      if (enabledControl === 'left') {
        $("#carousel_sec_espiritual .carousel-inner .carousel-item").animate({ left: '0px' }, 1000 ); 
